...
转载于 链接：https://pdai.tech/md/java/jvm/java-jvm-agent-usage.html
...
![img](/_images/java/java-jvm-agent-1.png)
...
![img](/_images/java/java-jvm-agent-2.png)
...
![img](/_images/java/java-jvm-agent-3.png)
...
![img](/_images/java/java-jvm-agent-4.png)
...
![img](/_images/java/java-jvm-agent-5.png)
...
![img](/_images/java/java-jvm-agent-6.png)
...
![img](/_images/java/java-jvm-agent-7.png)
...
![img](/_images/java/java-jvm-agent-8.jpg)
...
- [ASM 4 guide  (opens new window)](https://asm.ow2.io/asm4-guide.pdf)
- [Java Virtual Machine Specification  (opens new window)](https://docs.oracle.com/javase/specs/jvms/se7/html/jvms-4.html)
- [JVM Tool Interface  (opens new window)](https://docs.oracle.com/javase/8/docs/platform/jvmti/jvmti.html)
- [alibaba arthas  (opens new window)](https://alibaba.github.io/arthas/)
