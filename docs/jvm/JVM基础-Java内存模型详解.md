...
转载于 链接：https://pdai.tech/md/java/jvm/java-jvm-jmm.html
...
![img](/docs/jvm/imgs/java-jmm-1.png)
...
![img](/docs/jvm/imgs/java-jmm-2.png)
...
![img](/docs/jvm/imgs/java-jmm-3.png)
...
![img](/docs/jvm/imgs/java-jmm-4.png)
...
![img](/docs/jvm/imgs/java-jmm-5.png)
...
![img](/docs/jvm/imgs/java-jmm-6.png)

如上图所示，A 和 C 之间存在数据依赖关系，同时 B 和 C 之间也存在数据依赖关系。因此在最终执行的指令序列中，C 不能被重排序到 A 和 B 的前面（C 排到 A 和 B 的前面，程序的结果将会被改变）。但 A 和 B 之间没有数据依赖关系，编译器和处理器可以重排序 A 和 B 之间的执行顺序。下图是该程序的两种执行顺序：

![img](/docs/jvm/imgs/java-jmm-7.png)
...
![img](/docs/jvm/imgs/java-jmm-8.png)
...
![img](/docs/jvm/imgs/java-jmm-9.png)
...
![img](/docs/jvm/imgs/java-jmm-10.png)
...
![img](/docs/jvm/imgs/java-jmm-11.png)

现在我们再假设这两个线程没有做同步，下面是这个未同步程序在顺序一致性模型中的执行示意图：

![img](/docs/jvm/imgs/java-jmm-12.png)
...
![img](/docs/jvm/imgs/java-jmm-13.png)
...
![img](/docs/jvm/imgs/java-jmm-14.png)
...
![img](/docs/jvm/imgs/java-jmm-15.png)
...
![img](/docs/jvm/imgs/java-jmm-x03.png)
...
![img](/docs/jvm/imgs/java-jmm-x04.png)
