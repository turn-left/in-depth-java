package com.ethen.alipay.demo.main;
...
import com.ethen.alipay.demo.trade.config.Configs;
import com.ethen.alipay.demo.trade.model.ExtendParams;
import com.ethen.alipay.demo.trade.model.GoodsDetail;
import com.ethen.alipay.demo.trade.model.builder.*;
import com.ethen.alipay.demo.trade.model.hb.*;
import com.ethen.alipay.demo.trade.model.result.AlipayF2FPayResult;
import com.ethen.alipay.demo.trade.model.result.AlipayF2FPrecreateResult;
import com.ethen.alipay.demo.trade.model.result.AlipayF2FQueryResult;
import com.ethen.alipay.demo.trade.model.result.AlipayF2FRefundResult;
import com.ethen.alipay.demo.trade.service.AlipayMonitorService;
import com.ethen.alipay.demo.trade.service.AlipayTradeService;
import com.ethen.alipay.demo.trade.service.impl.AlipayMonitorServiceImpl;
import com.ethen.alipay.demo.trade.service.impl.AlipayTradeServiceImpl;
import com.ethen.alipay.demo.trade.service.impl.AlipayTradeWithHBServiceImpl;
import com.ethen.alipay.demo.trade.utils.Utils;
import com.ethen.alipay.demo.trade.utils.ZxingUtils;
    ...
    public void test_trade_precreate() {
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format(Configs.getQrCodePath(), response.getOutTradeNo());
                // 生成二维码并保存
