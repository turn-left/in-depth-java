package com.ethen.alipay.demo.trade.config;
...
public class Configs {
    ...
    private static String qrCodePath; // 当面付二维码存放路径 added by ethen since 2021/12/25
    ...
    public synchronized static void init(String filePath) {
        ...
        qrCodePath = configs.getString("alipay_qrcode_path");
